...
- [Publishing and consuming V6.0.0](#publishing-and-consuming-v401)
...
V6.0.0 has explicit release gates for both the Python compiler and dbt package.
...
`incremental` materialization is deliberately not advertised in V6.0.0 until watermark and merge semantics are fully declarative.
...
V6.0.0 therefore provides a real companion dbt package called:
...
| First public release details                        | [V6.0.0 release notes](V6.0.0_RELEASE_NOTES.md) |

---

# Publishing and consuming V6.0.0
