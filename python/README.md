...
The `det` CLI turns the controlled V5.0.0 official-ODCS Excel superset into
...
V5.0.0 makes the visible official `Quality` sheet authoritative, preserves
...
```bash
python -m pip install dbt-data-engineering-toolkit-compiler==5.0.0
```
